...
void loop() 
{
    ...
    stepper.step(1, 100);  // move motor 1000 steps in one direction
    delay(1000);            // short stop
    stepper.step(0, 100);  // move motor 1000 steps in the other dirction
    delay(1000);            //short stop
    }
...
char menu()
{
    ...
    Serial.println(F("(1) Stepper Motor"));
